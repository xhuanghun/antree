...
<link rel="stylesheet" type="text/css" href="${msUrl}/css/enter.css">
<link rel="stylesheet" type="text/css" media="screen" href="${easyuiUrl}/themes/icon.css" >
<script type="text/javascript" src="${easyuiUrl}/jquery-1.8.0.min.js"></script>
