							...
							<div class=user_main_box>
								<ul>
									...
									<li class=user_main_input>
										<input class="txtusernamecssclass easyui-validatebox"  data-options="required:true,validType:'login',missingMessage:'用户名不能为空.',invalidMessage:'用户格式不正确'" name="login"  value="admin" maxlength="20">
									</li>
								</ul>
								<ul>
									<li class=user_main_text>
				...
				<dd id=user_bottom>
					<ul>
						...
						<li class=user_bottom_c>
							<span style="margin-top: 40px">海口金政信息科技有限公司  <a
								href="http://www.jzgis.com">WWW.JZGIS.COM</a>.</span>
						</li>
